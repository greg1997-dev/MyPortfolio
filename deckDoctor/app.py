    ...
    if st.button("Generate Deck"):
        with st.spinner("Searching database and consulting AI..."):
            ...
            prompt = f"""
                ...
                7. MANDATORY: Format the decklist as 'Quantityx Card Name' (e.g., 3x Ash Blossom & Joyous Spring). Do not use bolding or special characters inside the card names.
            """
